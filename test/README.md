...
This folder contains unit tests, using [bats](https://github.com/bats-core/bats-core).
...
Probably you want test just one file. To do, run `./node_modules/.bin/bats unit/filename.bats`.
