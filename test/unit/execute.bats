...
@test "pdcdef_execute: test function and command" {
    ...
    pdcyml_settings_executors__command[0]="shell"
    pdcyml_settings_executors__function[0]="shell_test"
    shell_test() { eval "$1" ; }
    log_info() { echo ; }
...
@test "pdcdef_execute: test many functions and commands" {
    ...
    pdcyml_settings_executors__command[0]="shell"
    pdcyml_settings_executors__command[1]="sh"
    pdcyml_settings_executors__command[2]="bash"

    pdcyml_settings_executors__function[0]="shell_test"
    pdcyml_settings_executors__function[1]="sh_test"
    pdcyml_settings_executors__function[2]="bash_test"
